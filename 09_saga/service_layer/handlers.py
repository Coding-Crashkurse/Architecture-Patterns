...
def build_handler_maps() -> tuple[dict, dict]:
    ...
    from service_layer import saga

    def notify_transfer(event, bus) -> None:
        notifications.append(
            {
    ...
    command_handlers = {
        ...
        RequestTransfer: saga.request_transfer,
        ShipBook: saga.ship_book,
        ReceiveBook: saga.receive_book,
        CompensateShipment: saga.compensate_shipment,
    }
    event_handlers: dict = {
        ...
        TransferRequested: [saga.on_transfer_requested, notify_transfer],
        BookShipped: [saga.on_book_shipped, notify_transfer],
        BookReceived: [notify_transfer],
        TransferCompleted: [notify_transfer],
        TransferFailed: [notify_transfer],
    }
